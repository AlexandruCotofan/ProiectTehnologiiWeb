...
class User
{
    ...
    public function insertDb($user_data)
    {
        ...
        $insert= $mysqli->query("INSERT INTO info(inaltime,greutate,grupa_muschi_1,locatie,dificultate,email) VALUES ('$this->inaltime','$this->greutate','$this->grupa_muschi_1', '$this->locatie','$this->dificultate','$email')");
