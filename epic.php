  ...
  <section id="banner">
      ...
      <p>Train like a beast, look like a beauty.</p>
          <div class="banner-btn">
              <a href="generare.php"><span></span>GENERATOR</a>
              <a href="statistici.php"><span></span>STATISTICS</a>
          </div>
      </div>
  </section>
    ...
    <div id="sideNav">
      <nav>
        <ul>
             ...
             <li><a href="citate.html">MOTIVATIONAL QUOTES</a></li>
            <li><a href="recomand.php">SALI RECOMANDATE</a></li>
            <li><a href="https://cdt-babes.ro/articole/indicele-de-masa-corporala-imc.php">CALCULATOR IMC</a></li>
